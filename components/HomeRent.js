            ...
            <div className={homeBuy.new_dev_container}>
                ...
                <div className={homeBuy.card_container}>
                    <div className={ homeBuy.cards}>
                        ...
                        <div className={homeBuy.property_price}>＄1,450/Month</div>
